...
trait ScreenExecutionTrait {
  ...
  private static function confirmExecuteStatements($currentOnly) {
    ...
    \SPTK\Elements\WarningPanel::forge(
      ...
      [
        ['text' => 'Execute', 'hotKey' => 'RETURN', 'onPress' => $currentOnly ? '\MADB\Main\QueryExecutionController::doExecuteCurrentQuery' : '\MADB\Main\QueryExecutionController::doExecuteQuery'],
