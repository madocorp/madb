...
class GeneratedQueryController extends \MADB\Main\ScreenController {
  ...
  private static function showPanel(string $titleText, string $sql, bool $allowNoRefreshRun): void {
    ...
    new \SPTK\Elements\Space($buttons);
    self::addButton($buttons, 'F4', 'MADB\Query\GeneratedQueryController::openInEditor', 'Editor');
    new \SPTK\Elements\Space($buttons);
  ...
  private static function confirmBeforeRun($panel, bool $refreshAfterRun): bool {
    ...
    \SPTK\Elements\WarningPanel::forge(
      ...
      $content,
      [
        ['text' => 'Run', 'hotKey' => 'RETURN', 'onPress' => '\MADB\Query\GeneratedQueryController::runConfirmed'],
